...
namespace Ep128ImgConv {
  ...
  void ImageConv_TVCPixel2::initializePalettes()
  {
    for (int i = 0; i < 256; i++)
      convertTVCColorToYUV(i, paletteY[i], paletteU[i], paletteV[i]);
  }

  void ImageConv_TVCPixel2::randomizePalette(int yc, int seedValue)
  {
    int     tmp = 0;
  ...
  double ImageConv_TVCPixel2::calculateLineError(int yc, double maxError)
  {
    float   tmpPaletteY[5];
    float   tmpPaletteU[5];
    float   tmpPaletteV[5];
  ...
  double ImageConv_TVCPixel2::calculateTotalError(double maxError)
  {
    double  totalError = 0.0;
  ...
  double ImageConv_TVCPixel2::optimizeLinePalette(int yc, int optimizeLevel)
  {
  ...
  double ImageConv_TVCPixel2::optimizeImagePalette(int optimizeLevel)
  {
    double  bestError = 1000000000.0;
    int     bestPalette[2];
    bestPalette[0] = 0;
    bestPalette[1] = 0;
    int     progressCnt = 0;
    int     progressMax = optimizeLevel * 3 * 2 * 15;
    for (int l = 0; l < optimizeLevel; l++) {
  ...
  void ImageConv_TVCPixel2::sortLinePalette(int yc)
  {
    // sort palette colors by color value
    if (!(fixedColors[0] || fixedColors[1] ||
  ...
  void ImageConv_TVCPixel2::setFixedPalette()
  {
  ...
  void ImageConv_TVCPixel2::pixelStoreCallback(void *userData, int xc, int yc,
                                               float y, float u, float v)
  {
    ImageConv_TVCPixel2&  this_ =
        *(reinterpret_cast<ImageConv_TVCPixel2 *>(userData));
    yc = yc >> 1;
  ...
  void ImageConv_TVCPixel2::pixelStoreCallbackI(void *userData, int xc, int yc,
                                                float y, float u, float v)
  {
    ImageConv_TVCPixel2&  this_ =
        *(reinterpret_cast<ImageConv_TVCPixel2 *>(userData));
  ...
  ImageConv_TVCPixel2::ImageConv_TVCPixel2()
    : ImageConverter(),
      width(1),
      height(1),
  ...
  bool ImageConv_TVCPixel2::processImage(
