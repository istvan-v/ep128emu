...
#ifndef EPIMGCONV_PIXEL16_2_HPP
#define EPIMGCONV_PIXEL16_2_HPP
...
namespace Ep128ImgConv {
  ...
  class ImageConv_Pixel16_2 : public ImageConverter {
   protected:
    int           width;
    int           height;
    ...
    void optimizeLinePalette_fast(int yc);
