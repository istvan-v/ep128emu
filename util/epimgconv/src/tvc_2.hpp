...
#ifndef EPIMGCONV_TVC_2_HPP
#define EPIMGCONV_TVC_2_HPP
...
namespace Ep128ImgConv {
  ...
  class ImageConv_TVCPixel2 : public ImageConverter {
   protected:
    int           width;
    int           height;
