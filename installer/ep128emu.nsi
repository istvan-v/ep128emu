...
;General
  ...
  ;Name and file
  Name "ep128emu"
  OutFile "ep128emu-2.0.0-beta1.exe"
...
Section "Source code" SecSrc
  ...
  SetOutPath "$INSTDIR\src\plus4"

  File "..\plus4\*.cpp"
  File "..\plus4\*.hpp"
  File "..\plus4\*.py"

  SetOutPath "$INSTDIR\src\plus4\resid"

  File "..\plus4\resid\AUTHORS"
  File "..\plus4\resid\COPYING"
  File "..\plus4\resid\ChangeLog"
  File "..\plus4\resid\NEWS"
  File "..\plus4\resid\README"
  File "..\plus4\resid\THANKS"
  File "..\plus4\resid\TODO"
  File "..\plus4\resid\*.cpp"
  File "..\plus4\resid\*.hpp"

  SetOutPath "$INSTDIR\src\plus4\util"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\$MUI_TEMP\plus4 - OpenGL mode.lnk"
  Delete "$SMPROGRAMS\$MUI_TEMP\plus4 - software mode.lnk"
