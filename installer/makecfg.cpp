...
static const char *machineConfigFileNames[40] = {
  ...
  "P4_64k_PAL.cfg",                     // 26
  "P4_64k_NTSC.cfg",                    // 27
  "P4_16k_PAL_3PLUS1.cfg",              // 28
  "P4_16k_NTSC_3PLUS1.cfg",             // 29
  "P4_64k_PAL_3PLUS1.cfg",              // 30
  "P4_64k_NTSC_3PLUS1.cfg",             // 31
  "P4_16k_PAL_FileIO.cfg",              // 32
  "P4_16k_NTSC_FileIO.cfg",             // 33
  "P4_64k_PAL_FileIO.cfg",              // 34
  "P4_64k_NTSC_FileIO.cfg",             // 35
  "P4_16k_PAL_3PLUS1_FileIO.cfg",       // 36
  "P4_16k_NTSC_3PLUS1_FileIO.cfg",      // 37
  "P4_64k_PAL_3PLUS1_FileIO.cfg",       // 38
  "P4_64k_NTSC_3PLUS1_FileIO.cfg"       // 39
};
...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    if (gui->enableCfgInstall) {
      ...
      dsCfg = new Ep128EmuDisplaySndConfiguration(*config, false);
      ...
      delete dsCfg;
      config = new Ep128Emu::ConfigurationDB();
      mCfg = new Ep128EmuMachineConfiguration(*config, 30, romDirectory);
      dsCfg = new Ep128EmuDisplaySndConfiguration(*config, true);
