...
#define MAKE_DESCRIPTOR(client, port) ((void*)(((uintptr_t)(client) << 8) | (port)))
#define GET_DESCRIPTOR_CLIENT(info) ((((intptr_t)(info)) >> 8) & 0xff)
#define GET_DESCRIPTOR_PORT(info) (((intptr_t)(info)) & 0xff)
