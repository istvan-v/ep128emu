  ...
  class File {
   public:
    ...
    typedef enum {
      ...
      EP128EMU_CHUNKTYPE_TED_STATE =      0x4550800B,
      EP128EMU_CHUNKTYPE_P4VM_CONFIG =    0x4550800C,
      EP128EMU_CHUNKTYPE_P4VM_STATE =     0x4550800D,
      EP128EMU_CHUNKTYPE_PLUS4_DEMO =     0x4550800E,
      EP128EMU_CHUNKTYPE_PLUS4_PRG =      0x4550800F
    } ChunkType;
    // ----------------
