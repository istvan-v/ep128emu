...
namespace Plus4 {
  ...
  void TED7360::saveState(Ep128Emu::File::Buffer& buf)
  {
    ...
    buf.writeUInt32(attributeShiftRegister);
    buf.writeUInt32(characterShiftRegister);
    buf.writeUInt32(cursorShiftRegister);
    buf.writeUInt32(bitmapHShiftRegister);
    buf.writeUInt32(bitmapM0ShiftRegister);
    buf.writeUInt32(bitmapM1ShiftRegister);
  ...
  void TED7360::loadState(Ep128Emu::File::Buffer& buf)
  {
    ...
    try {
      ...
      attributeShiftRegister = buf.readUInt32();
      characterShiftRegister = buf.readUInt32();
      cursorShiftRegister = buf.readUInt32();
      bitmapHShiftRegister = buf.readUInt32();
      bitmapM0ShiftRegister = buf.readUInt32();
      bitmapM1ShiftRegister = buf.readUInt32();
