...
namespace Plus4 {
  ...
  public:
    ...
    inline void clock();
    inline void clock(cycle_count delta_t);
  ...
  protected:
    ...
    inline reg12 output____();
    inline reg12 output___T();
    inline reg12 output__S_();
    inline reg12 output__ST();
    inline reg12 output_P__();
    inline reg12 output_P_T();
    inline reg12 output_PS_();
    inline reg12 output_PST();
    inline reg12 outputN___();
    inline reg12 outputN__T();
    inline reg12 outputN_S_();
    inline reg12 outputN_ST();
    inline reg12 outputNP__();
    inline reg12 outputNP_T();
    inline reg12 outputNPS_();
  ...
  // --------------------------------------------------------------------------
  inline void WaveformGenerator::clock(cycle_count delta_t)
  {
    // No operation if test bit is set.
    if (test) {
      return;
  ...
  // Zero output.
  //
  inline reg12 WaveformGenerator::output____()
  {
    return 0x000;
  }
  ...
  //
  inline reg12 WaveformGenerator::output___T()
  {
    reg24 msb = (ring_mod ? accumulator ^ sync_source->accumulator
                            : accumulator)
                & 0x800000;
  ...
  //
  inline reg12 WaveformGenerator::output__S_()
  {
  ...
  //
  inline reg12 WaveformGenerator::output_P__()
  {
  ...
  //
  inline reg12 WaveformGenerator::outputN___()
  {
    return
  ...
  // in this case does not act as a digital state machine. Tests show that
  ...
  // The sample is output if the pulse output is on.
  //
  inline reg12 WaveformGenerator::output__ST()
  {
    return wave__ST[output__S_()] << 4;
  }

  inline reg12 WaveformGenerator::output_P_T()
  {
    return (wave_P_T[output___T() >> 1] << 4) & output_P__();
  }

  inline reg12 WaveformGenerator::output_PS_()
  {
    return (wave_PS_[output__S_()] << 4) & output_P__();
  }

  inline reg12 WaveformGenerator::output_PST()
  {
  ...
  //
  inline reg12 WaveformGenerator::outputN__T()
  {
    return 0;
  }

  inline reg12 WaveformGenerator::outputN_S_()
  {
    return 0;
  }

  inline reg12 WaveformGenerator::outputN_ST()
  {
    return 0;
  }

  inline reg12 WaveformGenerator::outputNP__()
  {
    return 0;
  }

  inline reg12 WaveformGenerator::outputNP_T()
  {
    return 0;
  }

  inline reg12 WaveformGenerator::outputNPS_()
  {
    return 0;
  }
