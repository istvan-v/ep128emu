...
namespace Ep128Emu {
  ...
  class Compressor_M2 {
   ...
   private:
    ...
    // --------
    Ep128Compress::EncodeTable  lengthEncodeTable;
    Ep128Compress::EncodeTable  offs1EncodeTable;
    Ep128Compress::EncodeTable  offs2EncodeTable;
    Ep128Compress::EncodeTable  offs3EncodeTable;
  ...
  void Compressor_M2::writeRepeatCode(std::vector< unsigned int >& buf,
                                      size_t d, size_t n)
  {
    Ep128Compress::EncodeTable& offsEncodeTable =
  ...
  Compressor_M2::Compressor_M2()
    : lengthEncodeTable(lengthNumSlots, lengthMaxValue,
      ...
      offs3NumSlots(4),
      offs3PrefixSize(2),
      searchTable((Ep128Compress::LZSearchTable *) 0)
  {
  }
