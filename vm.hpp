...
namespace Ep128Emu {
  ...
  class VirtualMachine {
   public:
    ...
    virtual void run(size_t microseconds) = 0;
    ...
    // are not saved.
    virtual void saveState(Ep128::File& f)
    {
      (void) f;
    }
    // Save clock frequency and timing settings.
    virtual void saveMachineConfiguration(Ep128::File& f)
    {
      (void) f;
    }
    ...
    // clear all breakpoints.
    virtual void registerChunkTypes(Ep128::File& f)
    {
      (void) f;
    }
    ...
    virtual void recordDemo(Ep128::File& f)
    {
      (void) f;
    }
    ...
    // ----------------
    virtual void loadState(Ep128::File::Buffer& buf)
    {
      (void) buf;
    }
    virtual void loadMachineConfiguration(Ep128::File::Buffer& buf)
    {
      (void) buf;
    }
    virtual void loadDemo(Ep128::File::Buffer& buf)
    {
      (void) buf;
    }
   protected:
